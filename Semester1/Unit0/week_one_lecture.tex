...
\item Office hours: Discord 918particle\#5083
\item Course pre-requisites: Calculus 1 (concurrently or previously, high-school equivalent).
\item Text: University Physics Volume 1 (see syllabus)
\item Homework: OpenStax Tutor (see syllabus)
\end{enumerate}
\end{frame}
...
For a list of helpful equations and mathematical definitions, see \alert{\textbf{Key Equations}} section of Chapter 2.
\end{frame}

...
\end{figure}
\begin{enumerate}
\item Suppose we are charging a car battery with an average current of $I = \Delta Q/\Delta t = 1.675$ Amps, for 4 hours.  (a) How many Coulombs of charge are in the battery? (b) If a battery has 13.4 Amp hr of charge, for how long can it provide 2.0 Amps of current?
...
\item Consider Fig. \ref{fig:complex}.  Let $V_1 = 15$ V, $V_2 = 1.5$ V, and all resistors have a value of $3$ k$\Omega$. (a) Solve for all currents through all resistors.  (b) Confirm your results in our DC circuit simulator.

...
\begin{itemize}
\item A: 0.001 sec (1 millisecond)
\item B: 0.12 sec (120 milliseconds)
\item C: 1.2 sec
\item D: 1 minute
\end{itemize}
\end{frame}
...
\begin{frame}{Newton's First Law}
A man slides a palette crate across a concrete floor of his shop.  He exerts a force of 60.0 N, and the box has a constant velocity of 0.5 m/s.  What force cancels his pushing force, and what is the value in Newtons?
\begin{itemize}
\item A: wind, 60.0 N

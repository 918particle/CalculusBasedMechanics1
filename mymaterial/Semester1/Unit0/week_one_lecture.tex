...
\small
\begin{minipage}[b]{0.45\linewidth}
A jar of coffee beans sits on a counter at a cafe.  If the jar is about 10 cm tall, and has a radius of about 5 cm, estimate the number of beans inside.
\begin{itemize}
\item A: 300 beans
\item B: 3000 beans
\item C: 30,000 beans
...
For a list of helpful equations and mathematical definitions, see p. 92 of the the text.
\end{frame}
...
\section{Lab Activity: Using data to derive speed from displacement}

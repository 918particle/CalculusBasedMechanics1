...
\begin{enumerate}
\item First, set air resistance to zero.
\item Make ten measurements of $g$ by creating some projectile trajectories and using the \textit{range equation}.  What value do you obtain, on average?
\item Now, turn on air resistance, and repeat the ten measurements.  What value do you obtain?

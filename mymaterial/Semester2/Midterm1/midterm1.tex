...
\begin{enumerate}
\item Derive (a) the electric field of a point charge using Gauss' Law.  (b) Derive the electric field versus $r$ of a solid sphere of constant charge density $\rho_0$ and radius $R$, for $r\leq R$ and $r>R$. \\ \vspace{3cm}
\end{enumerate}
\item \textbf{Chapter 7, Voltage}
\begin{enumerate}
\item An arch of electricity sends 2.0 C of charge through a potential difference of $10^5$ Volts. What energy was dissipated? \\ \vspace{2cm}
